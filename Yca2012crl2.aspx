<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Yca2012crl2.aspx.cs" Inherits="Yca2012crl2" %>
...
<body>
  ...
  <div id="container-content" style="width: 952px; height: 18%">      
        ...
        <tr style="height:25px">
                <td style="width: 222px;"><asp:Label ID="Label2" runat="server" Text="YCA Download(CRL)"></asp:Label><br /><br />
                </td>
        </tr>
        <tr style="height:25px">     
                <td style="width: 222px;">
                    <asp:LinkButton ID="LinkButton18" runat="server" OnClick="LinkButton18_Click"   >YCA CRL 3-9-2012 </asp:LinkButton> 
                    </td>
                               
             </tr>
              <tr style="height:25px">     
                <td style="width: 222px;">
                    <asp:LinkButton ID="LinkButton15" runat="server" OnClick="LinkButton15_Click"  >YCA CRL 27-8-2012 </asp:LinkButton>
                    </td>
                               
             </tr>
             <tr style="height:25px">     
                <td style="width: 222px;">
                    <asp:LinkButton ID="LinkButton13" runat="server" OnClick="LinkButton13_Click"  >YCA CRL 20-8-2012 </asp:LinkButton> 
                    </td>
                               
             </tr>
             <tr style="height:25px">     
                <td style="width: 222px; height: 25px;">
                    <asp:LinkButton ID="LinkButton12" runat="server" OnClick="LinkButton12_Click" >YCA CRL 13-8-2012 </asp:LinkButton> 
                    </td>
                               
             </tr>
             <tr style="height:25px">     
                <td style="width: 222px;">
                    <asp:LinkButton ID="LinkButton10" runat="server" OnClick="LinkButton10_Click" >YCA CRL 6-8-2012 </asp:LinkButton> 
                    </td>
                               
             </tr>
             <tr style="height:25px">     
                <td style="width: 222px;">
                    <asp:LinkButton ID="LinkButton6" runat="server" OnClick="LinkButton6_Click">YCA CRL 30-7-2012 </asp:LinkButton> 
                    </td>
                               
             </tr>
             <tr style="height:25px">     
                <td style="width: 222px;">
                    <asp:LinkButton ID="LinkButton2" runat="server" OnClick="LinkButton2_Click" >YCA CRL 23-7-2012 </asp:LinkButton> 
                    </td>
             </tr>
             <tr style="height:25px">     
                <td style="width: 222px;">
                    <asp:LinkButton ID="LinkButton1" runat="server" OnClick="LinkButton1_Click" >YCA CRL 7-7-2012 </asp:LinkButton> 
                    </td>
        ...
        <tr style="height:25px">     
                <td style="width: 222px; height: 25px;">
                    <asp:LinkButton ID="linkButton4" runat="server" OnClick="linkButton4_Click" >YCA CRL 12-3-2012 </asp:LinkButton> 
                    </td>
            ...
            <tr style="height:25px">     
                <td style="width: 222px; height: 25px;">
                    ...
                    <asp:LinkButton ID="LinkButton19" runat="server" PostBackUrl="~/Yca2015crl3.aspx">13</asp:LinkButton>
                    <asp:LinkButton ID="LinkButton20" runat="server" PostBackUrl="~/Yca2014crl.aspx">14</asp:LinkButton>
                    <asp:LinkButton ID="LinkButton21" runat="server" PostBackUrl="~/Yca2014crl2.aspx">15</asp:LinkButton>
                    <asp:LinkButton ID="LinkButton22" runat="server" PostBackUrl="~/Yca2014clr3.aspx">16</asp:LinkButton>
                    <asp:LinkButton ID="LinkButton23" runat="server" PostBackUrl="~/Yca2013crl.aspx">17</asp:LinkButton>
                    <asp:LinkButton ID="LinkButton24" runat="server" PostBackUrl="~/Yca2013crl2.aspx">18</asp:LinkButton>
                    <asp:LinkButton ID="LinkButton25" runat="server" PostBackUrl="~/Yca2013crl3.aspx">19</asp:LinkButton>
                    <asp:LinkButton ID="LinkButton26" runat="server" PostBackUrl="~/Yca2012crl.aspx">20</asp:LinkButton>
                    <asp:LinkButton ID="LinkButton27" runat="server" PostBackUrl="~/Yca2012crl2.aspx">21</asp:LinkButton></td>
