<%@ Page Language="C#" AutoEventWireup="true" CodeFile="YCA2018CRL3.aspx.cs" Inherits="YCA2018CRL3" %>
...
<body>
  ...
  <div id="container-content" style="width: 952px; height: 18%">      
        ...
        <tr style="height:25px">
                <td style="width: 222px; height: 25px;"><asp:Label ID="Label2" runat="server" Text="YCA Download(SHA1 CRL)"></asp:Label><br /><br />
                
                </td>
        </tr>
        <tr style="height:25px">
        <td style="width: 222px; height: 27px;">
            <asp:LinkButton ID="LinkButton23" runat="server" OnClick="LinkButton23_Click"   >YCA CRL 10-12-2018</asp:LinkButton>
                   
        </td>
        </tr>
         <tr style="height:25px">
        <td style="width: 222px; height: 27px;">
            <asp:LinkButton ID="LinkButton21" runat="server" OnClick="LinkButton21_Click"    >YCA CRL 3-12-2018</asp:LinkButton>
                   
        </td>
        </tr>
        <tr style="height:25px">
        <td style="width: 222px; height: 27px;">
            <asp:LinkButton ID="LinkButton20" runat="server" OnClick="LinkButton20_Click"    >YCA CRL 26-11-2018</asp:LinkButton>
                   
        </td>
        </tr>
        <tr style="height:25px">
        <td style="width: 222px; height: 27px;">
            <asp:LinkButton ID="LinkButton19" runat="server" OnClick="LinkButton19_Click"    >YCA CRL 19-11-2018</asp:LinkButton>
                   
        </td>
        </tr>
        <tr style="height:25px">
        <td style="width: 222px; height: 27px;">
            <asp:LinkButton ID="LinkButton18" runat="server" OnClick="LinkButton18_Click"   >YCA CRL 12-11-2018</asp:LinkButton>
                   
        </td>
        </tr>
        <tr style="height:25px">
        <td style="width: 222px; height: 27px;">
            <asp:LinkButton ID="LinkButton17" runat="server" OnClick="LinkButton17_Click"   >YCA CRL 5-11-2018</asp:LinkButton>
                   
        </td>
        </tr>
        <tr style="height:25px">
        <td style="width: 222px; height: 27px;">
            <asp:LinkButton ID="LinkButton16" runat="server" OnClick="LinkButton16_Click"   >YCA CRL 29-10-2018</asp:LinkButton>
                   
        </td>
        </tr>
        <tr style="height:25px">
        <td style="width: 222px; height: 27px;">
            <asp:LinkButton ID="LinkButton15" runat="server" OnClick="LinkButton15_Click"  >YCA CRL 22-10-2018</asp:LinkButton>
                   
        </td>
        </tr>
        <tr style="height:25px">
        <td style="width: 222px; height: 27px;">
            <asp:LinkButton ID="LinkButton14" runat="server" OnClick="LinkButton14_Click"  >YCA CRL 15-10-2018</asp:LinkButton>
                   
        </td>
        </tr>
        <tr style="height:25px">
        <td style="width: 222px; height: 27px;">
            <asp:LinkButton ID="LinkButton13" runat="server" OnClick="LinkButton13_Click"  >YCA CRL 8-10-2018</asp:LinkButton>
                   
        </td>
        </tr>
        <tr style="height:25px">
        <td style="width: 222px; height: 27px;">
            <asp:LinkButton ID="LinkButton12" runat="server" OnClick="LinkButton12_Click"   >YCA CRL 1-10-2018</asp:LinkButton>
                   
        </td>
        </tr>
        <tr style="height:25px">
        <td style="width: 222px; height: 27px;">
            <asp:LinkButton ID="LinkButton11" runat="server" OnClick="LinkButton11_Click"   >YCA CRL 24-9-2018</asp:LinkButton>
                   
        </td>
        </tr>
        <tr style="height:25px">
        <td style="width: 222px; height: 27px;">
            <asp:LinkButton ID="LinkButton10" runat="server" OnClick="LinkButton10_Click"  >YCA CRL 17-9-2018</asp:LinkButton>
                   
        </td>
        </tr>
        <tr style="height:25px">
        <td style="width: 222px; height: 27px;">
            <asp:LinkButton ID="LinkButton9" runat="server" OnClick="LinkButton9_Click" >YCA CRL 10-9-2018</asp:LinkButton>
                   
        </td>
        </tr>
        <tr style="height:25px">
        <td style="width: 222px; height: 27px;">
            <asp:LinkButton ID="LinkButton22" runat="server" OnClick="LinkButton22_Click"  >YCA CRL 3-9-2018</asp:LinkButton>
                   
        </td>
        </tr>
         <tr><td style="width: 222px; height: 61px;"><br /></td></tr>
           ...
           <tr style="height:25px">     
                <td style="width: 222px; height: 25px;">
                    ...
                    <asp:LinkButton ID="LinkButton4" runat="server" PostBackUrl="~/Yca2014clr3.aspx">16</asp:LinkButton>
                    <asp:LinkButton ID="LinkButton5" runat="server" PostBackUrl="~/Yca2013crl.aspx">17</asp:LinkButton>
                    <asp:LinkButton ID="LinkButton6" runat="server" PostBackUrl="~/Yca2013crl2.aspx">18</asp:LinkButton>
                    <asp:LinkButton ID="LinkButton7" runat="server" PostBackUrl="~/Yca2013crl3.aspx">19</asp:LinkButton>
                    <asp:LinkButton ID="LinkButton8" runat="server" PostBackUrl="~/Yca2012crl.aspx">20</asp:LinkButton>
