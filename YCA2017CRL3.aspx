<%@ Page Language="C#" AutoEventWireup="true" CodeFile="YCA2017CRL3.aspx.cs" Inherits="YCA2017CRL3" %>
...
<body>
  ...
  <div id="container-content" style="width: 952px; height: 18%">      
        ...
        <td style="width: 222px; height: 27px;">
            <asp:LinkButton ID="LinkButton20" runat="server" OnClick="LinkButton20_Click"   >YCA CRL 15-1-2018</asp:LinkButton>
                   
        </td>
        </tr>
        <tr style="height:25px">
        <td style="width: 222px; height: 27px;">
            <asp:LinkButton ID="LinkButton18" runat="server" OnClick="LinkButton18_Click"   >YCA CRL 8-1-2018</asp:LinkButton>
                   
        </td>
        </tr>
        <tr style="height:25px">
        <td style="width: 222px; height: 27px;">
            <asp:LinkButton ID="LinkButton17" runat="server" OnClick="LinkButton17_Click"   >YCA CRL 11-12-2017</asp:LinkButton>
                   
        </td>
        </tr>
        <tr style="height:25px">
        <td style="width: 222px; height: 27px;">
            <asp:LinkButton ID="LinkButton16" runat="server" OnClick="LinkButton16_Click"    >YCA CRL 4-12-2017</asp:LinkButton>
                   
        </td>
        </tr>
        <tr style="height:25px">
        <td style="width: 222px; height: 27px;">
            <asp:LinkButton ID="LinkButton15" runat="server" OnClick="LinkButton15_Click"    >YCA CRL 27-11-2017</asp:LinkButton>
                   
        </td>
        </tr>
        <tr style="height:25px">
        <td style="width: 222px; height: 27px;">
            <asp:LinkButton ID="LinkButton14" runat="server" OnClick="LinkButton14_Click"     >YCA CRL 20-11-2017</asp:LinkButton>
                   
        </td>
        </tr>
        <tr style="height:25px">
        <td style="width: 222px; height: 27px;">
            <asp:LinkButton ID="LinkButton13" runat="server" OnClick="LinkButton13_Click"    >YCA CRL 6-11-2017</asp:LinkButton>
                   
        </td>
        </tr>
        <tr style="height:25px">
        <td style="width: 222px; height: 27px;">
            <asp:LinkButton ID="LinkButton12" runat="server" OnClick="LinkButton12_Click"    >YCA CRL 30-10-2017</asp:LinkButton>
                   
        </td>
        </tr>
        <tr style="height:25px">
        <td style="width: 222px; height: 27px;">
            <asp:LinkButton ID="LinkButton11" runat="server" OnClick="LinkButton11_Click"    >YCA CRL 23-10-2017</asp:LinkButton>
                   
        </td>
        </tr>
        <tr style="height:25px">
        <td style="width: 222px; height: 27px;">
            <asp:LinkButton ID="LinkButton10" runat="server" OnClick="LinkButton10_Click"    >YCA CRL 16-10-2017</asp:LinkButton>
                   
        </td>
        </tr>
        <tr style="height:25px">
        <td style="width: 222px; height: 27px;">
            <asp:LinkButton ID="LinkButton9" runat="server" OnClick="LinkButton9_Click"   >YCA CRL 2-10-2017</asp:LinkButton>
                   
        </td>
        </tr>
        <tr style="height:25px">
        <td style="width: 222px; height: 27px;">
            <asp:LinkButton ID="LinkButton8" runat="server" OnClick="LinkButton8_Click"   >YCA CRL 25-9-2017</asp:LinkButton>
                   
        </td>
        </tr>
        <tr style="height:25px">
        <td style="width: 222px; height: 27px;">
            <asp:LinkButton ID="LinkButton7" runat="server" OnClick="LinkButton7_Click"    >YCA CRL 18-9-2017</asp:LinkButton>
                   
        </td>
        </tr>
        <tr style="height:25px">
        <td style="width: 222px; height: 27px;">
            <asp:LinkButton ID="LinkButton6" runat="server" OnClick="LinkButton6_Click"    >YCA CRL 11-9-2017</asp:LinkButton>
                   
        </td>
        </tr>        
        <tr style="height:25px">
        <td style="width: 222px; height: 27px;">
            <asp:LinkButton ID="LinkButton19" runat="server" OnClick="LinkButton19_Click"      >YCA CRL 4-9-2017</asp:LinkButton>
            <br />
