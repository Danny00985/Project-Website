...
public partial class Yca2012crl2 : System.Web.UI.Page
{
    ...
    protected void LinkButton1_Click(object sender, EventArgs e)
    {
        if (Page.IsPostBack)
        {
            ...
            //Response.AddHeader("content-disposition", "attachment; filename=download.doc");
            Response.ContentType = "application/CRL";
            Response.AddHeader("content-disposition", "attachment; filename=" + "YCA(7-7-2012).crl");

            string file = "YCA(7-7-2012).crl";
            string folderpath = Server.MapPath("~/Download");
            string f = (folderpath + "/" + file);
    ...
    protected void LinkButton2_Click(object sender, EventArgs e)
    {
        if (Page.IsPostBack)
        {
            ...
            //Response.AddHeader("content-disposition", "attachment; filename=download.doc");
            Response.ContentType = "application/CRL";
            Response.AddHeader("content-disposition", "attachment; filename=" + "YCA(23-7-2012).crl");

            string file = "YCA(23-7-2012).crl";
            string folderpath = Server.MapPath("~/Download");
            string f = (folderpath + "/" + file);
    ...
    protected void LinkButton6_Click(object sender, EventArgs e)
    {
        if (Page.IsPostBack)
        {
            ...
            //Response.AddHeader("content-disposition", "attachment; filename=download.doc");
            Response.ContentType = "application/CRL";
            Response.AddHeader("content-disposition", "attachment; filename=" + "YCA(30-7-2012).crl");

            string file = "YCA(30-7-2012).crl";
            string folderpath = Server.MapPath("~/Download");
            string f = (folderpath + "/" + file);
    ...
    protected void LinkButton10_Click(object sender, EventArgs e)
    {
        if (Page.IsPostBack)
        {
            ...
            //Response.AddHeader("content-disposition", "attachment; filename=download.doc");
            Response.ContentType = "application/CRL";
            Response.AddHeader("content-disposition", "attachment; filename=" + "YCA(6-8-2012).crl");

            string file = "YCA(6-8-2012).crl";
            string folderpath = Server.MapPath("~/Download");
            string f = (folderpath + "/" + file);
    ...
    protected void LinkButton12_Click(object sender, EventArgs e)
    {
        if (Page.IsPostBack)
        {
            ...
            //Response.AddHeader("content-disposition", "attachment; filename=download.doc");
            Response.ContentType = "application/CRL";
            Response.AddHeader("content-disposition", "attachment; filename=" + "YCA(13-8-2012).crl");

            string file = "YCA(13-8-2012).crl";
            string folderpath = Server.MapPath("~/Download");
            string f = (folderpath + "/" + file);
    ...
    protected void LinkButton13_Click(object sender, EventArgs e)
    {
        if (Page.IsPostBack)
        {
            ...
            //Response.AddHeader("content-disposition", "attachment; filename=download.doc");
            Response.ContentType = "application/CRL";
            Response.AddHeader("content-disposition", "attachment; filename=" + "YCA(20-8-2012).crl");

            string file = "YCA(20-8-2012).crl";
            string folderpath = Server.MapPath("~/Download");
            string f = (folderpath + "/" + file);
    ...
    protected void LinkButton15_Click(object sender, EventArgs e)
    {
        if (Page.IsPostBack)
        {
            ...
            //Response.AddHeader("content-disposition", "attachment; filename=download.doc");
            Response.ContentType = "application/CRL";
            Response.AddHeader("content-disposition", "attachment; filename=" + "YCA(27-8-2012).crl");

            string file = "YCA(27-8-2012).crl";
            string folderpath = Server.MapPath("~/Download");
            string f = (folderpath + "/" + file);
    ...
    protected void LinkButton18_Click(object sender, EventArgs e)
    {
        if (Page.IsPostBack)
        {
            ...
            //Response.AddHeader("content-disposition", "attachment; filename=download.doc");
            Response.ContentType = "application/CRL";
            Response.AddHeader("content-disposition", "attachment; filename=" + "YCA(3-9-2012).crl");

            string file = "YCA(3-9-2012).crl";
            string folderpath = Server.MapPath("~/Download");
            string f = (folderpath + "/" + file);
