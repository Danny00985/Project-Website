<%@ Page Language="C#" AutoEventWireup="true" CodeFile="YCA2018CRL4.aspx.cs" Inherits="YCA2018CRL4" %>
...
<body>
  ...
  <div id="container-content" style="width: 952px; height: 18%">      
        ...
        <td style="width: 222px; height: 27px;">
            <asp:LinkButton ID="LinkButton12" runat="server" OnClick="LinkButton12_Click"   >YCA CRL 14-1-2019</asp:LinkButton>
                   
        </td>
        </tr>
        <tr style="height:25px">
        <td style="width: 222px; height: 27px;">
            <asp:LinkButton ID="LinkButton11" runat="server" OnClick="LinkButton11_Click"   >YCA CRL 7-1-2019</asp:LinkButton>
                   
        </td>
        </tr>
        <tr style="height:25px">
        <td style="width: 222px; height: 27px;">
            <asp:LinkButton ID="LinkButton10" runat="server" OnClick="LinkButton10_Click"   >YCA CRL 24-12-2018</asp:LinkButton>
                   
        </td>
        </tr>
        <tr style="height:25px">
        <td style="width: 222px; height: 27px;">
            <asp:LinkButton ID="LinkButton23" runat="server" OnClick="LinkButton23_Click"  >YCA CRL 17-12-2018</asp:LinkButton>
         ...
         <tr><td style="width: 222px"><br /></td></tr>
            ...
            <tr style="height:25px">     
                <td style="width: 222px; height: 25px;">
                    ...
                    <asp:LinkButton ID="LinkButton9" runat="server" PostBackUrl="~/Yca2012crl2.aspx">21</asp:LinkButton></td>
