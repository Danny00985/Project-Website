<%@ Page Language="C#" AutoEventWireup="true" CodeFile="YCA2017CRL2.aspx.cs" Inherits="YCA2017CRL2" %>
...
<body>
  ...
  <div id="container-content" style="width: 952px; height: 18%">      
        ...
        <td style="width: 222px; height: 26px;">
            <asp:LinkButton ID="LinkButton19" runat="server" OnClick="LinkButton19_Click"     >YCA CRL 28-8-2017</asp:LinkButton>
            
        </td>
        </tr>
        <tr style="height:25px">
        <td style="width: 222px; height: 26px;">
            <asp:LinkButton ID="LinkButton17" runat="server" OnClick="LinkButton17_Click"     >YCA CRL 21-8-2017</asp:LinkButton>
            
        </td>
        </tr>
        <tr style="height:25px">
        <td style="width: 222px; height: 26px;">
            <asp:LinkButton ID="LinkButton16" runat="server" OnClick="LinkButton16_Click"     >YCA CRL 14-8-2017</asp:LinkButton>
            
        </td>
        </tr>
        <tr style="height:25px">
        <td style="width: 222px;">
            <asp:LinkButton ID="LinkButton15" runat="server" OnClick="LinkButton15_Click"    >YCA CRL 7-8-2017</asp:LinkButton>
            
        </td>
        </tr>
        <tr style="height:25px">
        <td style="width: 222px;">
            <asp:LinkButton ID="LinkButton14" runat="server" OnClick="LinkButton14_Click"    >YCA CRL 31-7-2017</asp:LinkButton>
            
        </td>
        </tr>
        <tr style="height:25px">
        <td style="width: 222px;">
            <asp:LinkButton ID="LinkButton13" runat="server" OnClick="LinkButton13_Click"   >YCA CRL 24-7-2017</asp:LinkButton>
            
        </td>
        </tr>
        <tr style="height:25px">
        <td style="width: 222px;">
            <asp:LinkButton ID="LinkButton12" runat="server" OnClick="LinkButton12_Click"   >YCA CRL 17-7-2017</asp:LinkButton>
            
        </td>
        </tr>
        <tr style="height:25px">
        <td style="width: 222px;">
            <asp:LinkButton ID="LinkButton11" runat="server" OnClick="LinkButton11_Click"   >YCA CRL 10-7-2017</asp:LinkButton>
            
        </td>
        </tr>
         <tr style="height:25px">
        <td style="width: 222px;">
            <asp:LinkButton ID="LinkButton10" runat="server" OnClick="LinkButton10_Click"  >YCA CRL 3-7-2017</asp:LinkButton>
            
        </td>
        </tr>
         <tr style="height:25px">
        <td style="width: 222px;">
            <asp:LinkButton ID="LinkButton9" runat="server" OnClick="LinkButton9_Click"  >YCA CRL 26-6-2017</asp:LinkButton>
            
        </td>
        </tr>
         <tr style="height:25px">
        <td style="width: 222px;">
            <asp:LinkButton ID="LinkButton8" runat="server" OnClick="LinkButton8_Click" >YCA CRL 19-6-2017</asp:LinkButton>
            
        </td>
        </tr>
        <tr style="height:25px">
        <td style="width: 222px;">
            <asp:LinkButton ID="LinkButton7" runat="server" OnClick="LinkButton7_Click"  >YCA CRL 12-6-2017</asp:LinkButton>
            
        </td>
        </tr>
        <tr style="height:25px">
        <td style="width: 222px;">
            <asp:LinkButton ID="LinkButton6" runat="server" OnClick="LinkButton6_Click"  >YCA CRL 5-6-2017</asp:LinkButton>
            
        </td>
        </tr>
        <tr style="height:25px">
        <td style="width: 222px;">
            <asp:LinkButton ID="LinkButton5" runat="server" OnClick="LinkButton5_Click" >YCA CRL 29-5-2017</asp:LinkButton>
            
        </td>
        </tr>
        <tr style="height:25px">
        <td style="width: 222px;">
            <asp:LinkButton ID="LinkButton18" runat="server" OnClick="LinkButton18_Click"  >YCA CRL 22-5-2017</asp:LinkButton>
